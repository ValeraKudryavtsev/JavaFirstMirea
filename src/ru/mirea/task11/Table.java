        ...
        table.addMouseListener(new MouseListener() {
            public void mouseClicked(MouseEvent e) {
                if(table.isColumnSelected(1) == true && table.isRowSelected(0) == true)
                    JOptionPane.showMessageDialog(Table.this, "Добро пожаловать в Норильск!");
                if(table.isColumnSelected(0) == true && table.isRowSelected(1) == true)
                    JOptionPane.showMessageDialog(Table.this, "Добро пожаловать в Калининград!");
                if(table.isColumnSelected(1) == true && table.isRowSelected(1) == true)
                    JOptionPane.showMessageDialog(Table.this, "Добро пожаловать в Москву!");
                if(table.isColumnSelected(2) == true && table.isRowSelected(1) == true)
                    JOptionPane.showMessageDialog(Table.this, "Добро пожаловать в Магадан!");
                if(table.isColumnSelected(1) == true && table.isRowSelected(2) == true)
                    JOptionPane.showMessageDialog(Table.this, "Добро пожаловать в Сочи!");
            }
